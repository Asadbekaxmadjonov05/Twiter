...
const TokentContext = ({children}) => {
    ...
    const [postLIist, setPostList] = useState(JSON.parse(window.localStorage.getItem("postlist"))  || [
        {
          id:1,
          name:"Designsta",
          imgUrl:designstaImg,
    ...
    window.localStorage.setItem("postlist", JSON.stringify(postLIist))
   return( <Context.Provider value={{token, setToken, postLIist, setPostList}}>{children}</Context.Provider>)
}
